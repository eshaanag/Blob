    ...
    >
      <View className="flex-1 px-8 pb-10 pt-16">
        ...
        <View className="flex-1 items-center justify-center">
          ...
          <Text className="text-center text-lg leading-7 text-gray-500 dark:text-gray-400">
        ...
        <View className="mt-12">
          <Pressable
            className="h-16 items-center justify-center rounded-2xl bg-orange-500 active:bg-orange-600"
